            ...
            <Layout className="bg-light">
                <div className="container mx-auto px-4 py-8">
                    ...
                    <div className="text-center">
                        <Link href="/InscribirSuministro" className="inline-block bg-primary hover:bg-thirty text-white font-bold py-2 px-8 rounded-full transition-colors duration-300">
                            Inscribir Suministro
                        </Link>
                    </div>
                </div>
            </Layout>
